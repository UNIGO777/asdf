    ...
    <section className="py-16 px-4 relative z-10 w-full overflow-hidden bg-white bg-[#ebe5de]">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row">
          {/* Left column - Image */}
          <motion.div
            className="md:w-1/2 max-h-[60vh] overflow-hidden "
            initial={{ opacity: 0, x: -20 }}
            whileInView={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.8 }}
          >
            <img 
              src="https://images.unsplash.com/photo-1683791895200-201c0c40310f?q=80&w=2340&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" 
              alt="Praying Hands" 
          ...
          >
            <div className="text-center mb-6">
              <h3 className="text-sm uppercase tracking-wider text-orange-600 mb-2">JOIN OUR CAUSE</h3>
              <h2 className="text-2xl font-bold mb-2 text-gray-900 kalam-regular">Rakta Daan Registration</h2>
              <p className="text-sm text-gray-600">
                Fill out this form to register as a blood donor. Your contribution can save lives.
              </p>
            </div>
            ...
            {submitSuccess ? (
              ...
              >
                <p className="text-green-700">Thank you for registering! We will contact you soon with more details about upcoming donation drives.</p>
              </motion.div>
            ) : (
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  <label htmlFor="bloodGroup" className="block kalam-regular text-sm font-medium text-gray-700 mb-1">Blood Group</label>
                  <select
                    id="bloodGroup"
                    name="bloodGroup"
...
export default RaktdanRegister