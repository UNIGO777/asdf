...
const TempleContribute = () => {
  ...
  return (
    <section className="py-16 px-4  w-full overflow-hidden relative z-10 bg-white bg-[#ebe5de]">
        ...
        <div className="flex flex-col md:flex-row">
          ...
          >
            <div className="text-center mb-6">
              <h3 className="text-sm uppercase tracking-wider text-orange-600 mb-2">SUPPORT OUR TEMPLE</h3>
              <h2 className="text-2xl font-bold mb-2 text-gray-900 kalam-regular">Make a Contribution</h2>
            ...
            {submitSuccess ? (
              ...
              >
                <p className="text-green-700">Thank you for your generous contribution! We will send you the receipt shortly.</p>
              </motion.div>
            ) : (
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  <label htmlFor="amount" className="block text-sm font-medium text-gray-700 mb-1 kalam-regular">Contribution Amount (₹)</label>
                  <input
                    type="number"
                    id="amount"
                    name="amount"
                ...
                <div>
                  <label htmlFor="purpose" className="block text-sm font-medium text-gray-700 mb-1 kalam-regular">Purpose of Contribution</label>
                  <select
                    id="purpose"
                    name="purpose"
...
export default TempleContribute
